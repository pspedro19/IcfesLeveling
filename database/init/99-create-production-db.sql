...
-- ALTER DATABASE icfes_production SET log_connections = on; -- Commented: causes error
-- ALTER DATABASE icfes_production SET log_disconnections = on; -- Commented: causes error
